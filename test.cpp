...
int main() {
  ...
  P.dataTernak.getElement(2, 2)->setBerat(25);
  ...
  P.dataTernak.getElement(4, 4)->setBerat(25);

  P.getData().setElement(new Produk("APP", "APPLE", "PRODUCT_FRUIT_PLANT", "APPLE_TREE", 4, 8), 2, 2);

  P.panenTernak(game_object);

  P.getData().cetakPenyimpanan();
  P.dataTernak.cetakPenyimpanan();
